...
var _page = function _page() {
  ...
  return React.createElement(View.default, null, React.createElement(View.default, _rollupPluginBabelHelpers.extends({
    ...
    scrollTop: 0
  }), React.createElement(Swiper.default, null), React.createElement(View.default, null, React.createElement(View.default, null, React.createElement(ScrollView.default, null), React.createElement(Swiper.default, null), React.createElement(Text.default, null, React.createElement(Text.default, null, "text")))));
};
